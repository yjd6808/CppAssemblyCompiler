...
# main.cpp:28:     printf("max(3, 5, 7) = %d\n", max(3, 5, 7));
...
# main.cpp:29:     printf("max(-1, -5, -3) = %d\n", max(-1, -5, -3));
	.loc 1 29 11 is_stmt 0 view .LVU5
	movl	$-3, %edx	#,
	movl	$-5, %esi	#,
	movl	$-1, %edi	#,
	call	max	#
...
# main.cpp:30:     printf("max(1, 10, 5) = %d\n", max(1, 10, 5));
	.loc 1 30 11 is_stmt 0 view .LVU7
	movl	$5, %edx	#,
	movl	$10, %esi	#,
	movl	$1, %edi	#,
	call	max	#
...
# /usr/include/c++/8/iostream:74:   static ios_base::Init __ioinit;
	...
	.loc 2 74 25 is_stmt 0 view .LVU11
...
.LBE7:
# main.cpp:31: }
	.loc 1 31 1 view .LVU12
	addq	$8, %rsp	#,
	.cfi_def_cfa_offset 8
.LBB8:
.LBB6:
# /usr/include/c++/8/iostream:74:   static ios_base::Init __ioinit;
	.loc 2 74 25 view .LVU13
	jmp	__cxa_atexit	#
.LVL8:
.LBE6:
.LBE8:
...
.LASF33:
	.string	"value"
.LASF470:
	.string	"/home/jdyun/Makes/7. test17"
.LASF429:
	.string	"remove"
.LASF100:
	.string	"_Traits"
