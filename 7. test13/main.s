...
# main.cpp:21:     printf("fact(5) = %d\n", fact(5));
	.loc 1 21 11 view .LVU3
	movl	$5, %edi	#,
	call	fact	#
.LVL0:
	movl	$.LC0, %edi	#,
...
# main.cpp:22:     printf("fact(4) = %d\n", fact(4));
	.loc 1 22 11 is_stmt 0 view .LVU5
	movl	$4, %edi	#,
	call	fact	#
.LVL2:
	movl	$.LC1, %edi	#,
	...
	call	printf	#
.LVL3:
	.loc 1 24 5 is_stmt 1 view .LVU6
# main.cpp:25: }
	.loc 1 25 1 is_stmt 0 view .LVU7
	xorl	%eax, %eax	#
	addq	$8, %rsp	#,
...
.LBE7:
# main.cpp:25: }
	.loc 1 25 1 view .LVU11
	addq	$8, %rsp	#,
	.cfi_def_cfa_offset 8
.LBB8:
.LBB6:
# /usr/include/c++/8/iostream:74:   static ios_base::Init __ioinit;
	.loc 2 74 25 view .LVU12
	jmp	__cxa_atexit	#
.LVL6:
.LBE6:
.LBE8:
...
.LASF471:
	.string	"/home/jdyun/Makes/7. test13"
.LASF33:
	.string	"value"
.LASF166:
	.string	"_IO_read_end"
