...
# main.cpp:20:     printf("max(3, 5) = %d\n", max(3, 5));
	.loc 1 20 11 view .LVU3
	movl	$5, %esi	#,
	movl	$3, %edi	#,
	call	max	#
.LVL0:
	...
	call	printf	#
.LVL1:
	.loc 1 21 5 is_stmt 1 view .LVU4
# main.cpp:21:     printf("max(-1, -5) = %d\n", max(-1, -5));
	.loc 1 21 11 is_stmt 0 view .LVU5
	movl	$-5, %esi	#,
	movl	$-1, %edi	#,
	call	max	#
.LVL2:
...
# /usr/include/c++/8/iostream:74:   static ios_base::Init __ioinit;
	...
	.loc 2 74 25 is_stmt 0 view .LVU9
...
.LASF33:
	.string	"value"
.LASF470:
	.string	"/home/jdyun/Makes/7. test16"
.LASF166:
	.string	"_IO_read_end"
.LASF429:
	.string	"remove"
