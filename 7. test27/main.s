...
a:
	...
	.align 8
.LC0:
	.string	"a[] = {1, 2, 3, 4, 5, 6, 7, 8} = %d\n"
	.align 8
.LC1:
	.string	"a[] = {0, 2, 4, 6, 8, 10, 12, 14} = %d\n"
	.text
	.globl	main
	.type	main, @function
main:
...
.L5:
	.loc 1 33 22 discriminator 3
	cmp	DWORD PTR [rbp-8], 7
	jg	.L4
	.loc 1 34 18 discriminator 2
...
.LFB2159:
	...
	jne	.L9
	.loc 1 39 1 is_stmt 0 discriminator 1
...
.LASF298:
	.string	"__off_t"
.LASF688:
	.string	"/home/jdyun/Makes/7. test27"
.LASF677:
