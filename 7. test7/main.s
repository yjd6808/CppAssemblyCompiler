...
.LFB1700:
	...
	.loc 1 21 5 view .LVU2
# main.cpp:20:     a = a - b;
	.loc 1 20 7 is_stmt 0 view .LVU3
	movl	%edi, %eax	# a, a
	subl	%esi, %eax	# b, a
.LVL1:
# main.cpp:22: }
...
# main.cpp:25: {
	.loc 1 25 1 is_stmt 0 view .LVU10
	subq	$8, %rsp	#,
	.cfi_def_cfa_offset 16
# main.cpp:29:     f(i, j);
	.loc 1 29 6 view .LVU11
	movl	$20, %esi	#,
.LVL3:
	.loc 1 29 6 view .LVU12
	movl	$10, %edi	#,
.LVL4:
	.loc 1 29 6 view .LVU13
	call	f	#
.LVL5:
	.loc 1 31 5 is_stmt 1 view .LVU14
	.loc 1 20 5 view .LVU15
	.loc 1 21 5 view .LVU16
	.loc 1 33 5 view .LVU17
# main.cpp:33:     printf("i = %d\nj = %d\n", i, j);
	.loc 1 33 11 is_stmt 0 view .LVU18
	movl	$20, %edx	#,
	movl	$10, %esi	#,
	xorl	%eax, %eax	#
	movl	$.LC0, %edi	#,
...
# /usr/include/c++/8/iostream:74:   static ios_base::Init __ioinit;
	...
	.loc 2 74 25 is_stmt 0 view .LVU23
...
.LASF113:
	.string	"wcin"
.LASF475:
	.string	"/home/jdyun/Makes/7. test7"
.LASF468:
	.string	"argv"
.LASF158:
	.string	"__value"
...
.LASF105:
	.string	"cout"
.LASF485:
	.string	"_GLOBAL__sub_I__Z4funcii"
.LASF173:
